...
class __TwigTemplate_b2387520ddfe0f875c5c40099a27c33eaa4874826795a23b6180eb0a6664a77a extends Template
{
    private $source;
    private $macros = [];
    ...
    <button style=\"font-weight: bold;\" class=\"btn\">";
        // line 3
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 3, $this->source); })()), "Nahrát!")) : ("Nahrát!")), "html", null, true);
        echo "</button>
";
        // line 4
...
";
    ...
    {{ form_widget(form) }}
    <button style=\"font-weight: bold;\" class=\"btn\">{{ button_label|default('Nahrát!') }}</button>
{{ form_end(form) }}
