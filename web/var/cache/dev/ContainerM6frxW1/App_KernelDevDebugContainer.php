...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\EventUserController' => 'getEventUserControllerService',
    ...
    protected function getTwigService()
    {
        ...
        $instance->addGlobal('layout', 'custom');
        $instance->addGlobal('author', 'Roman Dušek');
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'mailtofrom' => 'romik.dusek@seznam.cz',
            'mailto' => 'romik.dusek@seznam.cz',
            'locale' => 'cs',
            'lang' => [
                0 => 'cs',
                1 => 'de',
